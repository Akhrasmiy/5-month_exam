...
const { Option } = Select;
const datae={}
  axios.get(`http://167.235.158.238:3001/invoices/40`).then((response => {
    if (response.status === 200) {
      OneContent(response)
    }
  }))
const OneContent = (date) => {
  console.log(date);
  const { id } = useParams();
  ...
  return <div className="addFed">
    ...
    <div className='nomsiz'>
      ...
      <Input placeholder='description' ref={descriptionref} defaultValue={""} id="description" />
